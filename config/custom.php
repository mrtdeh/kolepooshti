...
return [
    'custom' => [
        ...
        'navbarBgColor' => 'gradient-45deg-amber-amber', //Options: cyan,teal,light-blue,amber (any of materializecolor class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'activeMenuColor' => 'gradient-45deg-amber-amber', //Sidebar active menu color (any of materializecolor class can be pass)
        ...
        'templateTitle' => 'کوله پشتی', //template Title can be changes default('Materialize)
        'isCustomizer' => true, //If True customizer available or false its not available
        'defaultLanguage' => 'fa', //set your default language Options: en(default),pt,fr,de
        'largeScreenLogo' => 'images/logo/kolepooshti-logo-color.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'images/logo/kolepooshti-logo.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
