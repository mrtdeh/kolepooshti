    ...
    <div class="row">
                            ...
                            <div class="row">
                                <div class="col s12 l6">
                                    <div class="input-field">
                                        ...
                                        <select class="select2 browser-default error validate" id="course" name="course" required>
                                            <option value="0" disabled selected>انتخاب درس</option>
                                            <optgroup label="دوازدهم ریاضی الف" class="text-bold">
                                                <option value="">حسابان - محمدرضا انتظاری</option>
                                                <option value="">فیزیک - فرهاد آبشوری</option>
                                                <option value="">شیمی - سعید آسایش</option>
                                                <option value="">زبان - علی جلالی</option>
                                            </optgroup>
                                            <optgroup label="دوازدهم ریاضی ب">
                                                <option value="">حسابان - حسین فتوحی</option>
                                                <option value="">فیزیک - علی ضرابیه</option>
                                                <option value="">شیمی - علی طاهرنژاد</option>
                                                <option value="">زبان - دینیار فرهی فر</option>
                                            </optgroup>
                                        </select>
                                    </div> 
                                </div>
                                <div class="col s12 l6">
                                    <div class="input-field">
                                        ...
                                        <select class="error validate" id="week_plan" name="week_plan" required>
                                            <option value="" disabled selected>انتخاب زمانبندی</option>
                                            <option value="0">09:30 - 08:00</option>
                                            <option value="1">11:15 - 09:45</option>
                                            <option value="2" class="border-bottom-1">13:00 - 11:30</option>
                                ...
                                <div class="col s12 l6">
                                    <div class="input-field">
                                        ...
                                        <select class="error validate" id="week_day" name="week_day" required>
                                ...
                                <div class="col s12 l6">
                                    <div class="input-field">
                                        ...
                                        <select class="error validate" id="week_turn" name="week_turn" required>
                ...
                <div class="card border-padding">
                    <div class="card-content border-dashed">
                        <table class="subscription-table responsive-table bordered highlight centered">
                            ...
                            <tbody>
                                <tr>
                                    <th class="pink white-text center">شنبه</th>
                                    <td class="double"><span class="d-block border-bottom-1-dark pb-3">حسابان</span><span class="d-block pt-3">شیمی</span></td>
                                    <td>شیمی</td>
                                    <td>زبان انگلیسی</td>
                                </tr>
                                <tr>
                                    <th class="pink white-text center">یکشنبه</th>
                                    <td>عربی</td>
                                    <td>ادبیات فارسی</td>
                                    <td>دین و زندگی</td>
                                </tr>
                                <tr>
                                    <th class="pink white-text center">دوشنبه</th>
                                    <td>هندسه</td>
                                    <td>فیزیک</td>
                                    <td>دین و زندگی</td>
                                </tr>
                                <tr>
                                    <th class="pink white-text center">سه‌شنبه</th>
                                    <td>گسسته</td>
                                    <td>شیمی</td>
                                    <td>زبان انگلیسی</td>
                                </tr>
                                <tr>
                                    <th class="pink white-text center">چهارشنبه</th>
                                    <td>عربی</td>
                                    <td>ورزش</td>
                                    <td class="double"><span class="d-block border-bottom-1-dark pb-3">فیزیک</span><span class="d-block pt-3">هندسه</span></td>
                                </tr>
                                <tr>
                                    <th class="pink white-text center">پنجشنبه</th>
                                    <td>شیمی</td>
                                    <td>حسابان</td>
                                    <td>هندسه</td>
                                </tr>
        ...
        <div class="col l8 s12 hide add_plan">
            ...
            <div id="add_plan">
                <div class="card border-padding">
                    <div class="card-content border-dashed">
                        <form action="" id="formValidate1" class="formValidate">
                            <div class="row">
                                <div class="col s12 l6">
                                    <div class="input-field">
                                        <i class="fad fa-clock prefix"></i>
                                ...
                                <div class="col s12 l6">
                                    <div class="input-field">
                                        <i class="fad fa-clock prefix"></i>
                                        <input type="text" class="timepicker validate" name="end_time" required>
