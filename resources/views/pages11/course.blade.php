...
<div class="section animate fadeUp" id="section_course">
    <div class="row">
        ...
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light red" href="{{ url('/base/class/course') }}">
                        <i class="fal fa-infinity"></i>
                    </a>
                    <p class="pt-10">حسابان</p>
                    <p class="small pt-10">دبیر: محمدرضا انتظاری</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light blue" href="{{ url('/base/class/course') }}">
                        <i class="fal fa-magnet"></i>
                    </a>
                    <p class="pt-10">فیزیک</p>
                    <p class="small pt-10">دبیر: فرهاد آبشوری</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light purple" href="{{ url('/base/class/course/chemistry') }}">
                        <i class="fal fa-atom"></i>
                    </a>
                    <p class="pt-10">شیمی</p>
                    <p class="small pt-10">دبیر: سعید آسایش</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light amber" href="{{ url('/base/class/course') }}">
                        <i class="fal fa-empty-set"></i>
                    </a>
                    <p class="pt-10">گسسته</p>
                    <p class="small pt-10">دبیر: محمود صالحی</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light green" href="{{ url('/base/class/course') }}">
                        <i class="fal fa-hexagon"></i>
                    </a>
                    <p class="pt-10">هندسه</p>
                    <p class="small pt-10">دبیر: محمود صالحی</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light" href="{{ url('/base/class/course') }}">
                        <i class="fal fa-books"></i>
                    </a>
                    <p class="pt-10">ادبیات فارسی</p>
                    <p class="small pt-10">دبیر: یدالله امیری‌کیا</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light brown" href="{{ url('/base/class/course') }}">
                        <i class="fal fa-kaaba"></i>
                    </a>
                    <p class="pt-10">عربی</p>
                    <p class="small pt-10">دبیر: علی علی‌کریمی</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light indigo" href="{{ url('/base/class/course') }}">
                        <i class="fal fa-font"></i>
                    </a>
                    <p class="pt-10">زبان انگلیسی</p>
                    <p class="small pt-10">دبیر: علیرضا جلالی</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light yellow" href="{{ url('/base/class/course') }}">
                        <i class="fal fa-mosque"></i>
                    </a>
                    <p class="pt-10">دین و زندگی</p>
                    <p class="small pt-10">دبیر: کاظم فیاضی</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form action="" id="formValidate" class="formValidate">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="text" placeholder="بنر درس" name="course_banner" required>
                            </div>
                        </div>
                        <div class="row">
    ...
    <script>
        ...
        $("#formValidate").validate({
            ...
            messages: {
                ...
                course_banner:{
                    required: "بنر درس را بارگذاری کنید!"
                },
            },
            errorElement : 'div',
