...
<div class="section animate fadeUp" id="section_base">
    <div class="row">
        ...
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center border-intro-padding">
                    <a class="btn-floating btn-large waves-effect waves-light" href="{{ url('/base/class') }}">
                        <i class="fas fa-users-class"></i>
                    </a>
                    <p class="pt-10">پایه دوازدهم</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center border-intro-padding">
                    <a class="btn-floating btn-large waves-effect waves-light green" href="{{ url('/base/class') }}">
                        <i class="fas fa-users-class"></i>
                    </a>
                    <p class="pt-10">پایه یازدهم</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center border-intro-padding">
                    <a class="btn-floating btn-large waves-effect waves-light red" href="{{ url('/base/class') }}">
                        <i class="fas fa-users-class"></i>
                    </a>
                    <p class="pt-10">پایه دهم</p>
                </div>
            </div>
        </div>
    </div>
