...
<div class="section animate fadeUp" id="section_class">
    <div class="row">
        ...
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    ...
                    <p class="pt-10">ریاضی الف</p>
                    <p class="small pt-10">معاون: علی‌اکبر اسماعیلی</p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l3">
        ...
        <div class="col s12 m6 l3">
            <div class="card gradient-shadow border-radius-3 border-padding">
                <div class="card-content border-dashed center">
                    <a class="btn-floating btn-large waves-effect waves-light purple" href="{{ url('/base/class/course') }}">
                        <i class="fas fa-chalkboard-teacher"></i>
                    </a>
                    <p class="pt-10">تجربی ب</p>
                    <p class="small pt-10">معاون: علی‌اکبر اسماعیلی</p>
                </div>
            </div>
        </div>
