...
$(function () {
  ...
  $(".notification-button, .help-button, .profile-button, .translation-button, .dropdown-settings").dropdown({
    inDuration: 300,
    outDuration: 225,
    constrainWidth: false,
    hover: false,
...
module.exports = __webpack_require__(/*! /home/mrtdeh/Documents/laravel/kolepooshti/resources/js/plugins.js */"./resources/js/plugins.js");
